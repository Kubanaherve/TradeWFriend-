...
debts: {
  ...
  sales: {
    ...
    deleteTodayConfirm:
      "Voulez-vous supprimer les ventes, articles à crédit et paiements d'aujourd'hui ?",
...
inbox: {
  ...
  settings: {
    ...
    backToDashboard: "Retour au tableau de bord",
    employeeRestriction:
      "Les employés ne doivent pas gérer les paramètres du commerce, les employés ou la réinitialisation.",
    dangerZone: "Zone dangereuse",
    factoryReset: "Réinitialisation complète",
    factoryResetConfirm:
      "Cela effacera les données de l'application dans la base de données et recommencera à zéro. Les clients, dettes, paiements, ventes, transactions, stock et paramètres financiers seront supprimés. Continuer ?",
